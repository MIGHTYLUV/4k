    ...
    try {
      ...
      if (args.length > 0 && typeof runArgs[0] === 'string') {
        try {
          ...
          if (('dahmermovies-4k' === 'olamovies' || 'dahmermovies-4k' === 'cineby') && rawId.startsWith('tt')) {
          ...
          // If given a plain text string title instead of an ID, resolve via TMDB search
            ...
            if (json && json.results && json.results.length > 0) {
              ...
              if ('dahmermovies-4k' === 'olamovies' || 'dahmermovies-4k' === 'cineby') {
                runArgs[0] = matchedId;
              }
            }
          }
